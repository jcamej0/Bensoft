...
app.controller('deporteestadisticas', function($scope, $http) {
    ...
    $http.get('/informacion', { params: { beneficio: 'Deporte' } }).then(function(data) {
    ...
    $http.get('/informacion1', { params: { beneficio: 'Deporte' } }).then(function(data) {

        $scope.totalbeneficiarioshombres = data.data;

    });

    $http.get('/informacion2', { params: { beneficio: 'Deporte' } }).then(function(data) {
    ...
    $http.get('/informacion3', { params: { beneficio: 'Deporte' } }).then(function(data) {
    ...
    $http.get('/informacion4', { params: { beneficio: 'Deporte' } }).then(function(data) {
    ...
    $http.get('/informacion5', { params: { beneficio: 'Deporte' } }).then(function(data) {
    ...
    $http.get('/informacion6', { params: { beneficio: 'Deporte' } }).then(function(data) {
    ...
    $http.get('/informacion7', { params: { beneficio: 'Deporte' } }).then(function(data) {
    ...
    $http.get('/informacion8', { params: { beneficio: 'Deporte' } }).then(function(data) {
    ...
    $http.get('/informacion9', { params: { beneficio: 'Deporte' } }).then(function(data) {
    ...
    $http.get('/informacion10', { params: { beneficio: 'Deporte' } }).then(function(data) {
    ...
    $http.get('/informacion11', { params: { beneficio: 'Deporte' } }).then(function(data) {
